@extends('layouts.admin',['title' => 'Edit Announcements']) 
@section('content')
...
<div class="row flex mb-1c">
    <div class="flex-1  py-2 align-middle">
        ...
        <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb"><span class="el-breadcrumb__item"><span role="link" class="el-breadcrumb__inner is-link"><a href="{{ url('admin/') }}">Dashboard</a></span>
            ...
            <span class="el-breadcrumb__item"><span role="link" class="el-breadcrumb__inner">Edit Announcement</span>
            <i class="el-breadcrumb__separator el-icon-arrow-right"></i>
            </span>
...
<div class="bg-white p-5">
    ...
    {!! Form::open([ 'url' => 'admin/news/edit/'.$news->id,'class' => 'form-horizontal']) !!}
    ...
    <span class="flex flex-2">
        {!! Form::textarea('message',$news->message,[ 'style' => 'height:150px','class' => 'el-input__inner', 'required' => "required"]) !!}
    </span>
    </span>
